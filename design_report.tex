...
% TODO: add tables and figures index
...
\begin{itemize}
    ...
    \item You will need an iterator to target the appropriate U$_s$ from the array of memory, that's the \textbf{Address pointer Unit}.
    \item \textbf{Time Pointer Unit} helps you to identify which T of the T$_s$ array we are currently handling.
